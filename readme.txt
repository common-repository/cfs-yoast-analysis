...
CFS Yoast Analysis will include content from [Custom Field Suite](https://wordpress.org/plugins/custom-field-suite/) powered `input[type="text"]`s and `textarea`s in Yoast SEO Content Analysis.

*Forked from [Yoast ACF Analysis](https://github.com/Yoast/yoast-acf-analysis)*
